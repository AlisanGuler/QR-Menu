...
// dizideki her bir eleman için ekrana buton basan function
export const renderButtons = (activeText) => {

  // Eskiden oluşturulan butonları kaldır
  buttonsArea.innerHTML = ""

  // butonların her biri için aşağıdaki adımlar izlenecek
  buttonData.forEach((btn) => {
    ...
    // 5- eğer ki butonun yazısı aktif yazı ile eşleşirse siyah yap
...
/*
<button data-id="all" class="btn btn-outline-dark">
  Hepsi
</button>
*/
